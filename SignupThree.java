        ...
        if(c6.isSelected()){ 
	        ...
	        try{
	        	 ...
	        	 if(ae.getSource()==b1){
	            	 ...
	            	 BufferedReader reader = new BufferedReader(new FileReader("notepad_signupThree.txt"));
	            	 BufferedReader reader2 = new BufferedReader(new FileReader("notepad_Login.txt"));
	                 String line;
	                 ...
	                 BufferedWriter writer = new BufferedWriter(new FileWriter("notepad_signupThree.txt", true));
	                 BufferedWriter writer2 = new BufferedWriter(new FileWriter("notepad_Login.txt", true));

	                 writer.write("formno:" + formno);
	                 writer.newLine();
	                 writer.write("atype:" + atype);
	                 writer.newLine();
	                 writer.write("cardno:" + cardno);
	                 writer.newLine();
	                 writer.write("pin:" + pin);
	                 writer.newLine();
	                 writer.write("facility:" + facility);
	                 writer.newLine();
	                
	                 writer.close();
	                 
	                 writer2.write("formno:" + formno);
	                 writer2.newLine();
	                 writer2.write("cardno:" + cardno);
	                 writer2.newLine();
	                 writer2.write("pin:" + pin);
	                 writer2.newLine();
